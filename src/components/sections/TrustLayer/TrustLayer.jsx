      ...
      <div className="wrap">
        <div className="trust-panel" data-reveal>
          <div className="trust-intro">
            ...
            <p>Evaluate delivery, communication, and team fit from full-time dedicated remote developers without becoming liable for PIP, severance, or another hiring cycle. Vedryx keeps the developer relationship operationally reversible.</p>
          </div>
