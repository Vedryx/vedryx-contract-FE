    ...
    <header className="hero" id="top">
      ...
      <div className="wrap">
        ...
        <p className="lead hero-sub">
          <span className="hero-sub-desktop">Vedryx Core removes the hiring drag of resume screening, calls, and interview scheduling. If a developer does not perform, Vedryx Core replaces them at no extra cost, as many times as needed, while you avoid PIP and severance liability.</span>
        ...
        <div className="hero-proofline" aria-label="Vedryx Core engagement safeguards">
