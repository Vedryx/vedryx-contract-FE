  ...
  return (
    <section className="section-pad closing" id="final-cta">
      <div className="wrap">
        ...
        <p className="lead" data-reveal data-delay="0.1">Tell us what you need. Vedryx brings vetted developers, replaces non-performers at no extra cost, and keeps PIP or severance off your books.</p>
